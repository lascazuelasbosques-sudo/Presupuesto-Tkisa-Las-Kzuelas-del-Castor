...
export const INITIAL_INGREDIENTS: Ingredient[] = [
  // Proteínas
  { id: 'i1', name: 'Pechuga de pollo deshebrada', unit: 'kg' },
  { id: 'i2', name: 'Pechuga de pollo en cubos', unit: 'kg' },
  { id: 'i3', name: 'Pollo en piezas', unit: 'kg' },
  { id: 'i4', name: 'Falda de res para deshebrar', unit: 'kg' },
  { id: 'i5', name: 'Bistec de res picado', unit: 'kg' },
  { id: 'i6', name: 'Fajitas de res', unit: 'kg' },
  { id: 'i7', name: 'Carne molida de res', unit: 'kg' },
  { id: 'i8', name: 'Chicharrón seco', unit: 'kg' },
  { id: 'i9', name: 'Chorizo de cerdo', unit: 'kg' },
  { id: 'i10', name: 'Carne molida de puerco', unit: 'kg' },
  { id: 'i11', name: 'Costilla de cerdo', unit: 'kg' },
  { id: 'i12', name: 'Carne de cerdo en trozos', unit: 'kg' },
  { id: 'i13', name: 'Salchicha de pavo', unit: 'pqte' },
  { id: 'i14', name: 'Jamón de pavo', unit: 'kg' },
  { id: 'i15', name: 'Huevo de gallina', unit: 'pza' },
  { id: 'i16', name: 'Longaniza', unit: 'kg' },
  { id: 'i17', name: 'Nuggets de pollo', unit: 'pqte' },
  
  // Vegetales y Frutas
  { id: 'i18', name: 'Jitomate', unit: 'kg' },
  { id: 'i19', name: 'Cebolla blanca', unit: 'kg' },
  { id: 'i20', name: 'Chile pimiento morrón', unit: 'pza' },
  { id: 'i21', name: 'Tomate verde', unit: 'kg' },
  { id: 'i22', name: 'Chile serrano', unit: 'pza' },
  { id: 'i23', name: 'Cilantro fresco', unit: 'manojo' },
  { id: 'i24', name: 'Ajo', unit: 'pza' },
  { id: 'i25', name: 'Papa blanca', unit: 'kg' },
  { id: 'i26', name: 'Zanahoria', unit: 'kg' },
  { id: 'i27', name: 'Chícharos', unit: 'kg' },
  { id: 'i28', name: 'Nopales picados', unit: 'kg' },
  { id: 'i29', name: 'Chile poblano tatemado', unit: 'kg' },
  { id: 'i30', name: 'Granos de elote', unit: 'kg' },
  { id: 'i31', name: 'Piña en almíbar', unit: 'pza' },
  { id: 'i32', name: 'Limón', unit: 'kg' },
  
  // Abarrotes y Condimentos
  { id: 'i33', name: 'Chile chipotle en adobo', unit: 'lata' },
  { id: 'i34', name: 'Aceite vegetal', unit: 'lt' },
  { id: 'i35', name: 'Tocino', unit: 'kg' },
  { id: 'i36', name: 'Queso tipo manchego', unit: 'kg' },
  { id: 'i37', name: 'Pasta de mole poblano', unit: 'g' },
  { id: 'i38', name: 'Caldo de pollo', unit: 'lt' },
  { id: 'i39', name: 'Chocolate de mesa', unit: 'pza' },
  { id: 'i40', name: 'Ajonjolí', unit: 'g' },
  { id: 'i41', name: 'Chile morita', unit: 'g' },
  { id: 'i42', name: 'Chile guajillo', unit: 'g' },
  { id: 'i43', name: 'Caldillo de jitomate', unit: 'ml' },
  { id: 'i44', name: 'Salsa cátsup', unit: 'frasco' },
  { id: 'i45', name: 'Crema ácida', unit: 'lt' },
  { id: 'i46', name: 'Mostaza', unit: 'frasco' },
  { id: 'i47', name: 'Mayonesa', unit: 'frasco' },
  { id: 'i48', name: 'Pan para hot dog', unit: 'pqte' },
  { id: 'i49', name: 'Pasta corta', unit: 'pqte' },
  { id: 'i50', name: 'Mantequilla', unit: 'g' },
  { id: 'i51', name: 'Flor de jamaica', unit: 'g' },
  { id: 'i52', name: 'Agua', unit: 'lt' },
  { id: 'i53', name: 'Azúcar', unit: 'kg' },
  { id: 'i54', name: 'Semillas de chía', unit: 'g' },
  { id: 'i55', name: 'Pulpa de tamarindo natural', unit: 'g' },
  
  // Nuevos ingredientes
  { id: 'i56', name: 'Carne molida de res y cerdo', unit: 'kg' },
  { id: 'i57', name: 'Sal de grano', unit: 'kg' },
  { id: 'i58', name: 'Pimienta negra molida', unit: 'g' },
  { id: 'i59', name: 'Bolillo o teleras', unit: 'pza' },
];
