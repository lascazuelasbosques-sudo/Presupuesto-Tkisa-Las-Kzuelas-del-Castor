...
export const INITIAL_INGREDIENTS: Ingredient[] = [
  // Proteínas (Precios Mayoreo Central de Abastos CDMX)
  { id: 'i1', name: 'Pechuga de pollo deshebrada', unit: 'kg', costPerUnit: 115 },
  { id: 'i2', name: 'Pechuga de pollo en cubos', unit: 'kg', costPerUnit: 120 },
  { id: 'i3', name: 'Pollo en piezas', unit: 'kg', costPerUnit: 68 },
  { id: 'i4', name: 'Falda de res para deshebrar', unit: 'kg', costPerUnit: 185 },
  { id: 'i5', name: 'Bistec de res picado', unit: 'kg', costPerUnit: 175 },
  { id: 'i6', name: 'Fajitas de res', unit: 'kg', costPerUnit: 180 },
  { id: 'i7', name: 'Carne molida de res', unit: 'kg', costPerUnit: 165 },
  { id: 'i8', name: 'Chicharrón seco', unit: 'kg', costPerUnit: 260 },
  { id: 'i9', name: 'Chorizo de cerdo', unit: 'kg', costPerUnit: 95 },
  { id: 'i10', name: 'Carne molida de puerco', unit: 'kg', costPerUnit: 100 },
  { id: 'i11', name: 'Costilla de cerdo', unit: 'kg', costPerUnit: 115 },
  { id: 'i12', name: 'Carne de cerdo en trozos', unit: 'kg', costPerUnit: 108 },
  { id: 'i13', name: 'Salchicha de pavo', unit: 'pqte', costPerUnit: 48 },
  { id: 'i14', name: 'Jamón de pavo', unit: 'kg', costPerUnit: 115 },
  { id: 'i15', name: 'Huevo de gallina', unit: 'pza', costPerUnit: 2.9 },
  { id: 'i16', name: 'Longaniza', unit: 'kg', costPerUnit: 105 },
  { id: 'i17', name: 'Nuggets de pollo', unit: 'pqte', costPerUnit: 75 },
  
  // Vegetales y Frutas (Precios Mayoreo Central de Abastos CDMX)
  { id: 'i18', name: 'Jitomate', unit: 'kg', costPerUnit: 24 },
  { id: 'i19', name: 'Cebolla blanca', unit: 'kg', costPerUnit: 16 },
  { id: 'i20', name: 'Chile pimiento morrón', unit: 'pza', costPerUnit: 9 },
  { id: 'i21', name: 'Tomate verde', unit: 'kg', costPerUnit: 20 },
  { id: 'i22', name: 'Chile serrano', unit: 'pza', costPerUnit: 1.2 },
  { id: 'i23', name: 'Cilantro fresco', unit: 'manojo', costPerUnit: 12 },
  { id: 'i24', name: 'Ajo', unit: 'pza', costPerUnit: 5.5 },
  { id: 'i25', name: 'Papa blanca', unit: 'kg', costPerUnit: 20 },
  { id: 'i26', name: 'Zanahoria', unit: 'kg', costPerUnit: 14 },
  { id: 'i27', name: 'Chícharos', unit: 'kg', costPerUnit: 38 },
  { id: 'i28', name: 'Nopales picados', unit: 'kg', costPerUnit: 28 },
  { id: 'i29', name: 'Chile poblano tatemado', unit: 'kg', costPerUnit: 55 },
  { id: 'i30', name: 'Granos de elote', unit: 'kg', costPerUnit: 45 },
  { id: 'i31', name: 'Piña en almíbar', unit: 'pza', costPerUnit: 38 },
  { id: 'i32', name: 'Limón', unit: 'kg', costPerUnit: 30 },
  
  // Abarrotes y Condimentos (Precios Mayoreo Central de Abastos CDMX)
  { id: 'i33', name: 'Chile chipotle en adobo', unit: 'lata', costPerUnit: 22 },
  { id: 'i34', name: 'Aceite vegetal', unit: 'lt', costPerUnit: 34 },
  { id: 'i35', name: 'Tocino', unit: 'kg', costPerUnit: 155 },
  { id: 'i36', name: 'Queso tipo manchego', unit: 'kg', costPerUnit: 145 },
  { id: 'i37', name: 'Pasta de mole poblano', unit: 'g', costPerUnit: 0.16 },
  { id: 'i38', name: 'Caldo de pollo', unit: 'lt', costPerUnit: 13 },
  { id: 'i39', name: 'Chocolate de mesa', unit: 'pza', costPerUnit: 9.5 },
  { id: 'i40', name: 'Ajonjolí', unit: 'g', costPerUnit: 0.10 },
  { id: 'i41', name: 'Chile morita', unit: 'g', costPerUnit: 0.38 },
  { id: 'i42', name: 'Chile guajillo', unit: 'g', costPerUnit: 0.30 },
  { id: 'i43', name: 'Caldillo de jitomate', unit: 'ml', costPerUnit: 0.04 },
  { id: 'i44', name: 'Salsa cátsup', unit: 'frasco', costPerUnit: 29 },
  { id: 'i45', name: 'Crema ácida', unit: 'lt', costPerUnit: 58 },
  { id: 'i46', name: 'Mostaza', unit: 'frasco', costPerUnit: 24 },
  { id: 'i47', name: 'Mayonesa', unit: 'frasco', costPerUnit: 38 },
  { id: 'i48', name: 'Pan para hot dog', unit: 'pqte', costPerUnit: 36 },
  { id: 'i49', name: 'Pasta corta', unit: 'pqte', costPerUnit: 15 },
  { id: 'i50', name: 'Mantequilla', unit: 'g', costPerUnit: 0.22 },
  { id: 'i51', name: 'Flor de jamaica', unit: 'g', costPerUnit: 0.25 },
  { id: 'i52', name: 'Agua', unit: 'lt', costPerUnit: 1.8 },
  { id: 'i53', name: 'Azúcar', unit: 'kg', costPerUnit: 27 },
  { id: 'i54', name: 'Semillas de chía', unit: 'g', costPerUnit: 0.14 },
  { id: 'i55', name: 'Pulpa de tamarindo natural', unit: 'g', costPerUnit: 0.12 },
  
  // Nuevos ingredientes (Precios Mayoreo Central de Abastos CDMX)
  { id: 'i56', name: 'Carne molida de res y cerdo', unit: 'kg', costPerUnit: 140 },
  { id: 'i57', name: 'Sal de grano', unit: 'kg', costPerUnit: 9 },
  { id: 'i58', name: 'Pimienta negra molida', unit: 'g', costPerUnit: 0.75 },
  { id: 'i59', name: 'Bolillo o teleras', unit: 'pza', costPerUnit: 3.8 },
];
