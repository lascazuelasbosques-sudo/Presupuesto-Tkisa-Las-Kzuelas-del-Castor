...
export const INITIAL_INGREDIENTS: Ingredient[] = [
  // Proteínas (Precios Ké Va Llevar)
  { id: 'i1', name: 'Pechuga de pollo deshebrada', unit: 'kg', costPerUnit: 145 },
  { id: 'i2', name: 'Pechuga de pollo en cubos', unit: 'kg', costPerUnit: 150 },
  { id: 'i3', name: 'Pollo en piezas', unit: 'kg', costPerUnit: 85 },
  { id: 'i4', name: 'Falda de res para deshebrar', unit: 'kg', costPerUnit: 220 },
  { id: 'i5', name: 'Bistec de res picado', unit: 'kg', costPerUnit: 210 },
  { id: 'i6', name: 'Fajitas de res', unit: 'kg', costPerUnit: 215 },
  { id: 'i7', name: 'Carne molida de res', unit: 'kg', costPerUnit: 195 },
  { id: 'i8', name: 'Chicharrón seco', unit: 'kg', costPerUnit: 350 },
  { id: 'i9', name: 'Chorizo de cerdo', unit: 'kg', costPerUnit: 130 },
  { id: 'i10', name: 'Carne molida de puerco', unit: 'kg', costPerUnit: 128 },
  { id: 'i11', name: 'Costilla de cerdo', unit: 'kg', costPerUnit: 148 },
  { id: 'i12', name: 'Carne de cerdo en trozos', unit: 'kg', costPerUnit: 140 },
  { id: 'i13', name: 'Salchicha de pavo', unit: 'pqte', costPerUnit: 65 },
  { id: 'i14', name: 'Jamón de pavo', unit: 'kg', costPerUnit: 165 },
  { id: 'i15', name: 'Huevo de gallina', unit: 'pza', costPerUnit: 4.0 },
  { id: 'i16', name: 'Longaniza', unit: 'kg', costPerUnit: 135 },
  { id: 'i17', name: 'Nuggets de pollo', unit: 'pqte', costPerUnit: 95 },
  
  // Vegetales y Frutas (Precios Ké Va Llevar)
  { id: 'i18', name: 'Jitomate Saladet chico', unit: 'kg', costPerUnit: 28 },
  { id: 'i19', name: 'Cebolla blanca', unit: 'kg', costPerUnit: 30 },
  { id: 'i20', name: 'Chile pimiento morrón', unit: 'pza', costPerUnit: 20 },
  { id: 'i21', name: 'Tomate verde', unit: 'kg', costPerUnit: 35 },
  ...
  { id: 'i26', name: 'Zanahoria', unit: 'kg', costPerUnit: 25 },
  { id: 'i27', name: 'Chícharos', unit: 'kg', costPerUnit: 58 },
  { id: 'i28', name: 'Nopales picados', unit: 'kg', costPerUnit: 45 },
  { id: 'i29', name: 'Chile poblano tatemado', unit: 'kg', costPerUnit: 85 },
  { id: 'i30', name: 'Granos de elote', unit: 'kg', costPerUnit: 65 },
  { id: 'i31', name: 'Piña en almíbar', unit: 'pza', costPerUnit: 60 },
  { id: 'i32', name: 'Limón', unit: 'kg', costPerUnit: 45 },
  
  // Abarrotes y Condimentos (Precios Ké Va Llevar)
  { id: 'i33', name: 'Chile chipotle en adobo', unit: 'lata', costPerUnit: 32 },
  { id: 'i34', name: 'Aceite vegetal', unit: 'lt', costPerUnit: 48 },
  { id: 'i35', name: 'Tocino', unit: 'kg', costPerUnit: 215 },
  ...
  { id: 'i42', name: 'Chile guajillo', unit: 'g', costPerUnit: 0.55 },
  ...
  { id: 'i49', name: 'Pasta corta', unit: 'pqte', costPerUnit: 28 },
  { id: 'i50', name: 'Mantequilla', unit: 'g', costPerUnit: 0.35 },
  { id: 'i51', name: 'Flor de jamaica', unit: 'g', costPerUnit: 0.45 },
  ...
  // Nuevos ingredientes (Precios Ké Va Llevar)
  { id: 'i56', name: 'Carne molida de res y cerdo', unit: 'kg', costPerUnit: 175 },
  { id: 'i57', name: 'Sal de grano', unit: 'kg', costPerUnit: 20 },
  { id: 'i58', name: 'Pimienta negra molida', unit: 'g', costPerUnit: 1.15 },
  { id: 'i59', name: 'Bolillo o teleras', unit: 'pza', costPerUnit: 6 },
  { id: 'i60', name: 'Aguacate Hass', unit: 'kg', costPerUnit: 90 },
];
